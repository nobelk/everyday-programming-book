# Chapter 12 — Scoping: Find the Bug, Solutions
...
### Solution 12.1.1 — reading a global from a function
...
### Solution 12.1.2 — a local name stays local
...
### Solution 12.1.3 — a global constant for area
...
### Solution 12.1.4 — the helper's result must come back out
...
### Solution 12.1.5 — global list, read inside the function
...
### Solution 12.2.1 — local hides global, on purpose
...
### Solution 12.2.2 — the local shadow should win inside
...
### Solution 12.2.3 — shadowing a built-in name
...
### Solution 12.2.4 — which value gets printed
...
### Solution 12.2.5 — parameter shadows the global
...
### Solution 12.3.1 — assigning makes it local
...
### Solution 12.3.2 — read before assign
...
### Solution 12.3.3 — counting without touching the global
...
### Solution 12.3.4 — local sum inside a loop
...
### Solution 12.3.5 — assignment creates a fresh local
...
### Solution 12.4.1 — declaring global
...
### Solution 12.4.2 — global then assign
...
### Solution 12.4.3 — global keyword spelling
...
### Solution 12.4.4 — accumulate into a global
...
### Solution 12.4.5 — global so the change sticks
...
### Solution 12.5.1 — nonlocal counter
...
### Solution 12.5.2 — running total in an enclosing scope
...
### Solution 12.5.3 — nonlocal keyword
...
### Solution 12.5.4 — which scope nonlocal targets
...
### Solution 12.5.5 — nonlocal vs global
...
### Solution 12.6.1 — self attribute vs local
...
### Solution 12.6.2 — reading an instance attribute
...
### Solution 12.6.3 — class variable shared by all
...
### Solution 12.6.4 — a local inside a method
...
### Solution 12.6.5 — updating an instance attribute
