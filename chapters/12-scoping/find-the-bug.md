# Chapter 12 — Scoping: Find the Bug
...
### Exercise 12.1.1 — reading a global from a function
...
### Exercise 12.1.2 — a local name stays local
...
### Exercise 12.2.1 — local hides global, on purpose
...
### Exercise 12.2.2 — the local shadow should win inside
...
### Exercise 12.3.1 — assigning makes it local
...
### Exercise 12.3.2 — read before assign
...
### Exercise 12.3.5 — assignment creates a fresh local
...
### Exercise 12.4.2 — global then assign
...
### Exercise 12.4.5 — global so the change sticks
...
### Exercise 12.5.2 — running total in an enclosing scope
...
### Exercise 12.5.3 — nonlocal keyword
...
### Exercise 12.5.5 — nonlocal vs global
...
### Exercise 12.6.2 — reading an instance attribute
