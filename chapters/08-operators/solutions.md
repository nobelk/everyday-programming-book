# Chapter 8 — Operators: Find the Bug, Solutions
...
### Solution 8.1.1 — Average of three test scores
...
### Solution 8.1.5 — Total cost with tax
...
### Solution 8.2.1 — Saving up for a bike
...
### Solution 8.2.2 — Counting down rocket seconds
...
### Solution 8.2.3 — Doubling a recipe
...
### Solution 8.2.4 — Splitting candy among friends
...
### Solution 8.2.5 — Running total of steps
...
### Solution 8.3.1 — Passing grade check
...
### Solution 8.3.2 — Are two distances equal?
...
### Solution 8.3.3 — Temperature in safe range
...
### Solution 8.3.4 — Different answers
...
### Solution 8.3.5 — Within speed limit
...
### Solution 8.4.1 — Eligible to vote
...
### Solution 8.4.2 — Weekend or holiday
...
### Solution 8.5.2 — Odd number not in list
...
### Solution 8.5.3 — Missing value check
...
### Solution 8.5.4 — First planet in the list
...
### Solution 8.5.5 — Day in the schedule
